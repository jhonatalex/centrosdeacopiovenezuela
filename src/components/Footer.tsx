          ...
          <div className="grid w-full max-w-xs grid-cols-2 gap-2">
            {contactos.map((c) => (
              <a
                ...
                className="flex items-center justify-center gap-1.5 rounded-full bg-[#25D366] px-3 py-2 text-xs font-bold text-white shadow-sm transition-transform active:scale-95"
              >
